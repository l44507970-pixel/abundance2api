...
2. 填写 `.env` 中的 `DEFAULT_API_KEY`、`ABUNDANCE_SESSION`、`ABUNDANCE_OIDC_TOKEN`。
...
- `ABUNDANCE_SESSION`：从 a.b.u.n.dance 登录态 Cookie 中复制。
- `ABUNDANCE_OIDC_TOKEN`：从 a.b.u.n.dance 登录态 Cookie 中复制。
